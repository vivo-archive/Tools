...
public class IO {
	...
	public static void fetch(String host, int port, Map<String, String> params) {

	}
	
	public static void translate(String host, int port, Map<String, String> params) {

	}
	
	public static void score(String host, int port, Map<String, String> params) {
